...
import { listGoodsReceipts, createGoodsReceipt, GoodsReceiptSchema } from "@/services/receiving-service";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await createGoodsReceipt(session, parsed.data, body.company_id);
