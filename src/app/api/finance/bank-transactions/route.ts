...
import { listBankTransactions, recordBankTransaction } from "@/services/bank-service";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await recordBankTransaction(session, body, post, body.company_id);
