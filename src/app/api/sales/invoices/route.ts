...
import { listCustomerInvoices, createCustomerInvoice, CustomerInvoiceSchema } from "@/services/customer-invoice-service";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await createCustomerInvoice(session, parsed.data, body.company_id);
